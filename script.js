const GAS_URL="https://script.google.com/macros/s/AKfycbz6AcmHTnKrApNczD70T9GN2nNxImwdIpGuR09smacDZHkjaYno_CuXBUvIoXXLceoE/exec";
...
try{await fetch(GAS_URL,{method:"POST",mode:"no-cors",body:sendData});form.reset();showStatus("お問い合わせを受け付けました。ありがとうございます。","ok")}catch(error){showStatus("送信に失敗しました。しばらく時間をおいてもう一度お試しください。","err")}finally{if(submitBtn)submitBtn.disabled=false}})}
